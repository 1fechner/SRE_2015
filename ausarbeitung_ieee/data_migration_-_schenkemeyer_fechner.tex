...
\author{
	\IEEEauthorblockN{Tobias Fechner und Julian Schenkemeyer}
	\IEEEauthorblockA{Universtit"at Hamburg (UHH)\\
%		Hamburg, Deutschland\\
		\href{mailto:1fechner@informatik.uni-hamburg.de;5schenke@informatik.uni-hamburg.de}{\{1fechner,5schenke\}@informatik.uni-hamburg.de}}\\ 
%	\and
%	\IEEEauthorblockN{Julian Schenkemeyer}
%	\IEEEauthorblockA{Universtit"at Hamburg\\
%		Hamburg, Deutschland\\
%		\href{mailto:5schenke@informatik.uni-hamburg.de}{5schenke@informatik.uni-hamburg.de}}\\ 
}
...
\input{10_section_einleitung/10_einleitung.tex}
\input{20_section_motivation/20_motivation.tex}
\input{40_section_projekt/40_projekt.tex}
\input{30_section_kategorien/30_kategorien.tex}
\input{50_section_vorgehensweisen/50_vorgehensweisen.tex}
\input{90_section_fazit/90_fazit.tex}
