...
%		\end{enumerate}
	...
	\begin{frame}
		...
		Es gibt nicht das eine Verfahren für die Datenmigration
		\begin{itemize}
			\item Was für ein Unternehmen liegt vor?
			\item Was für ein Legacy-System soll migriert werden?
			\item Welche Daten sollen migriert werden?
			\item Besteht schon das "neue System" oder muss dieses erst entwickelt werden?
		\end{itemize}
	\end{frame}
